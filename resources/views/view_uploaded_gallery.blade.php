		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="{{ url('file') }}" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Add New Album</span></a>
					</div>
				</div>
			</div>
          ...
          <td>{{ $file->description }}</td>
		   <?php  
			...
			<?php $picture = Str::substr($file->filenames,$i,20);
                $i = $i+20+3; ?>
		  <td><img src= "{{asset('/storage/gallery/'.$picture)}}" style="max-width:40px;"/></td>
		  
		  @endwhile
          
					<td>
            <a href="{{ route('delete20', ['id' => $file->id]) }}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
					</td>
					</tr>
          @endforeach
				</tbody>
