<html lang="en">
<head>
  <title>Add Festival Images</title>
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Festival Image <b>Uploads</b></h2>
                        </div>
...
<h3 class="jumbotron"><i class="glyphicon glyphicon-upload"></i> Festival Image  Upload</h3>
<form method="post" action="{{url('save_past_kananiyam')}}" enctype="multipart/form-data">
  {{csrf_field()}}
        <input type="text" name="year" class="form-control" placeholder="Enter Year"><br>
        <input type="file" name="filename" class="form-control" placeholder="Enter Title"><br>
