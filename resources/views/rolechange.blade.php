...
<div class="container contact">
	<div class="row">
		...
		<div class="col-md-9">
            ...
            <form action="{{ route('updatepassword3', ['id' => $user->id]) }}" method="POST">
              @csrf
              @method('PATCH')
                ...
                <div class="form-group">
				  <label class="control-label col-sm-2" for="regNo">REGISTRATION NUMBER:</label>
				  <div class="col-sm-10">
					<input type="text" class="form-control" id="regNo" name="regNo" value="{{$user->regNo}}" required="required">
				  </div>
				</div>
				<div class="form-group">
                ...
                <div class="form-group">
				  ...
				  <div class="col-sm-10">
					<input type="file" class="form-control" id="profile" placeholder="Enter Profile" name="profile" value="{{$user->profile}}">
				  </div>
				</div>
                <div class="form-group">
				  <label class="control-label col-sm-2" for="phone">PHONE:</label>
				  <div class="col-sm-10">
					<input type="text" class="form-control" id="phone" placeholder="Enter Phone Number" name="phone" value="{{$user->phone}}">
				  </div>
				</div>
                <div class="form-group">
				  <label class="control-label col-sm-2" for="profession">PROFESSION:</label>
				  <div class="col-sm-10">
					<input type="text" class="form-control" id="profession" placeholder="Enter Profession" name="profession" value="{{$user->profession}}" required="required">
				  </div>
				</div>
				<div class="form-group">
