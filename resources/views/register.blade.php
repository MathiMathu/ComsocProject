            ...
            <div class="col-lg-6">
                <div class="card1 card border-0 px-4 py-5">
                    ...
                    <div class="row px-3">
                        ...
                        <input type="password" name="email" placeholder="Enter a valid email">
                    </div>
                    <br>
                        <label class="mb-1">
						    <h6 class="mb-0 text-sm">Registration Number</h6>
                        </label>
                         <input class="mb-4" type="text" name="regNo" placeholder="Eg: 2017/CSC/00">
                     </div>
