	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="{{ url('add_images') }}" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> <span>Add Images</span></a>
					</div>
				</div>
			</div>
        ...
        @foreach ($data as $image)
          ...
          <td> <?php foreach (json_decode($image->filename)as $picture) { ?>
            <a href="/view_festival/{{$image->id}}"><img src="{{ asset('/image/'.$picture) }}" style="height:120px; width:200px"/></a>
           <?php } ?>
         </td>
					<td>

            <a href="/delete_images/{{$image->id}}" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
					</td>
					</tr>
          @endforeach
				</tbody>
